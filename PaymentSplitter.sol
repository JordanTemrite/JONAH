...
contract PaymentSplitter is Context, Ownable {
     ...
     */
    function _pendingPayment(address account, uint256 totalReceived, uint256 alreadyReleased ) public view returns (uint256) {
    ...
    function _removePayee(address _account) public onlyOwner {
